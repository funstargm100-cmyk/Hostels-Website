...
//   • platform fee                      = 5% × ((total commission × occ) + P)
...
function onPosterTypeChange() {
  ...
  if (hint) {
    hint.textContent = isAgent
      ? 'Posting as an agent — your commission is charged per occupant; the platform fee is 5% of (total commission × occupancy + price per person).'
